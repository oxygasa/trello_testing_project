...
* This project has a developing stage **"In progress"** and **"In maintaining"**.
...
**[Jenkins address](https://jenkins.epam.com/jenkins)
  and credentials** for the pipelines editing (After May 30, 2022 the server nodes have been stopped. Credentials are allowed only for a localhost node. Please, navigate to [GitHub Actions tab for the Trello repository](https://github.com/oxygasa/trello_testing_project/actions) to view the CI/CD reports generated by the git push trigger):
...
4. **[MAINTAINING. STOPPED ON 50%]** Make an Automation testing scenarios and code them.
...
**30 May - CI/CD changes**

The Server rental nodes trial has been ended. Only localhost node is allowed.
In this case, the GitHub Actions CI/CD has been activated.
