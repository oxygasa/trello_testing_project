...
public class SettingsTest {
    @Test(description = "TC ID TRE110 Profile and visibility section checking.",
            groups = {"critical_path"})
    public void profileAndVisibilityTest() {
    }

    @Test(description = "TC ID TRE111 Activity section checking.")
    public void activityTest() {
    }

    @Test(description = "TC ID TRE112 Cards section checking.")
    public void cardsTest() {
    }

    @Test(description = "TC ID TRE113 Change language section checking.",
            groups = {"critical_path"})
    public void changeLanguageTest() {
    }

    @Test(description = "TC ID TRE114 Change notification email frequency checking.",
            groups = {"critical_path"})
    public void changeNotificationEmailFrequencyTest() {
    }

    @Test(description = "TC ID TRE115 Allow desktop notifications checking.")
